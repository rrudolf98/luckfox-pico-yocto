...
#
# This mechanism follows the original Luckfox SDK concept, where BSP
# components are explicitly selected to be initialized and enabled at
# system startup.
#
# IMPORTANT:
...
# in the Linux kernel configuration (CONFIG_*). PACKAGECONFIG only
# controls which BSP components are activated at runtime.
#
# If a required kernel module is unavailable at runtime,
# luckfox-bsp-init will skip the component and print a warning.
#
